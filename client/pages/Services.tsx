...
const services: Service[] = [
  {
    name: "Brooming",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/d22d58dce650cb26250425ff6cd156d3ace05d9f?width=310"
  },
  {
    name: "Mopping", 
    image: "https://api.builder.io/api/v1/image/assets/TEMP/ad8612bffe5bd9ac95a7f53a455cfbaaf539296c?width=310"
  },
  {
    name: "Dusting",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/b484bf00b1d04f32711a591b52c0917bd5f92d65?width=310"
  },
  {
    name: "Toilet-cleaning",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/eff8d8cd3dedb7fee43861ac815fd27953945df9?width=310"
  },
  {
    name: "Utensils-washing",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/deb1178d917a0141bf69d04865b703cd03357368?width=310"
  },
  {
    name: "Kitchen-prep",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/1362aebc06a5635a394c74194e60bbaa8abd4030?width=310",
    comingSoon: true
  }
];
      ...
      <section className="px-7 py-4">
        ...
        <div className="mb-8">
          <p className="text-shynup-black font-instrument text-[17px] leading-normal">
            At <span className="font-jeju">Shynup</span>, we offer a wide-range of services to keep your house clean almost effortlessly, and elegantly! Here are the services we offer:
          </p>
        </div>
